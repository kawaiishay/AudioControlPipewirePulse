...
from ..Rework.DeviceBase import DeviceBase
...
class SetVolume(DeviceBase):
    ...
    def get_config_rows(self):
        self.extend_volume_switch = Adw.SwitchRow(title="EXTEND VOLUME")

        self.volume_scale = ScaleRow(title="VOLUME", value=0, min=0, max=100, step=1,
                                     text_left="0", text_right="100")
